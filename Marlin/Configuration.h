...
#define STRING_CONFIG_H_AUTHOR "(Brayton Stafford)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anycubic Kossel Mini"
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -22.5  // Z offset: -below +above  [the nozzle]
